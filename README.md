...
## 🚀 Características Clave y Nuevos Módulos (v2.2.2)
...
*   **Indicador de Versión**: Visibilidad en el menú lateral de la versión activa de la PWA (ej: `v2.2.2`).
...
1.  Abra el archivo [sw.js](file:///c:/Users/LpLeonnnc/Documents/web/produccion/sw.js) y modifique la constante `CACHE_NAME` incrementando el número de versión:
    ```javascript
    const CACHE_NAME = 'produc-v10'; // Cambiar de v9 a v10
    ```
